...
读取 `${CODEX_HOME:-~/.codex}/skills/ljg-card/assets/sketchnote_template.html`
...
```bash
node ${CODEX_HOME:-$HOME/.codex}/skills/ljg-card/assets/capture.js /tmp/ljg_cast_sketchnote_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
